...
//	protected static final String APP_UPDATE_SERVER_URL = "http://192.168.205.33:8080/Hello/api/update";
	...
	public  final String APK_DOWNLOAD_URL = "http://7xjvv2.com1.z0.glb.clouddn.com/latest.apk";
	public  final String APK_UPDATE_CONTENT = "这里有一个新版本,不错哦";
	public  final String APK_VERSION_CODE = "4";
